...
import { IndividualOrTeam, RepeatApplicant, SmallGrantsFormData } from '../../types';
      ...
      <FormProvider {...methods}>
        <form id='small-grants-form' onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormControl id='why-is-project-important-control' isRequired mb={8}>
            ...
            <PageText as='small' fontSize='helpText' color='brand.helpText'>
              How do you know people need what you&apos;re making? Why is this project important for
              your target demographic/problem area?
            </PageText>
          ...
          <Box display={repeatApplicant === 'Yes' ? 'block' : 'none'}>
            <Fade in={repeatApplicant === 'Yes'} delay={0.25}>
              <FormControl id='progress' isRequired={repeatApplicant === 'Yes'} mb={8}>
