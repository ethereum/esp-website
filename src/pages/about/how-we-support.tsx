...
const HowWeSupport: NextPage = () => {
  return (
    <>
      ...
      <Stack spacing={10}>
        <section id='grants'>
          <PageSection mb={6}>Grants</PageSection>

          <PageText mb={6}>
            When we say &quot;grants&quot;, we&apos;re referring to direct funding awarded following
            a formal application, review, and a decision made by the ESP team with input from
            technical advisors.
          </PageText>

          <PageText>
            Grants are not donations, nor do we expect financial return. We give grants to support
            recipients in building things that are vital to Ethereum&apos;s success without the need
            to commercialize their work, so that these resources remain free and open to all.
          </PageText>
        </section>

        <section id='grant-types'>
          <PageSection mb={6}>Grant types</PageSection>
          ...
          <List>
            ...
            <ListItem>
              ...
              Project Grants are targeted toward projects with multiple phases or components, longer
              timelines, more complex needs and greater financial or operational overhead.
            </ListItem>
            <ListItem>
              <strong>Event sponsorships:</strong> we accept sponsorship requests for events focused
              on Ethereum&apos;s technology and community through our small grants program.
            </ListItem>
          </List>
        </section>

        <section id='other-support'>
          <PageSection mb={6}>Other Support</PageSection>
