          ...
          <Box w={{ lg: '70%' }} px={{ md: 20 }} pr={{ lg: 12 }}>
            <Stack mb={8}>
              <section id='description' ref={ref}>
                <PageSubheading mb={8}>
                  We&apos;re calling all those interested in creating knowledge around the Ethereum
                  ecosystem!
                </PageSubheading>

                <PageText mb={6}>
                  Over recent years, the Ethereum community has grown immensely by putting together
                  developers, investors, artists, companies and even governments with a shared
                  vision of impact for this technology.
                </PageText>
                ...
                <PageText>
                  The Ethereum Foundation is therefore opening this grants round targeting academia
                  with the goal to stimulate open–source formal research related to Ethereum.
                </PageText>
              </section>
            </Stack>
            ...
            <Stack spacing={10}>
              <section id='submit-proposal' ref={ref2}>
                ...
                <PageText mb={6}>
                  Individual researchers with proven academic background, research centers,
                  universities, think-tanks, educators and other stakeholders devoting to research
                  on matters related to Ethereum and its ecosystem are encouraged to apply.
                </PageText>
                ...
                <PageText mb={6}>
                  ...
                  <Link
                    ...
                    href='https://notes.ethereum.org/1yuzsI1iSY2HjXrImX5y9Q'
                    isExternal
              ...
              <section id='selection-criteria' ref={ref5}>
                ...
                <List>
                  ...
                  <ListItem>Potential of long-term involvement in the Ethereum ecosystem.</ListItem>
                  <ListItem>
                    Analyses or visualizations that help a non-technical audience gain insight into
                    the research.
                  </ListItem>
                </List>
              </section>
              ...
              <section id='wishlist' ref={ref6}>
                ...
                <PageText mb={6}>
                  ...
                  following domain areas, but don’t let this restrict your creativity. Check out our{' '}
                  <Link
                    fontWeight={700}
                    color='brand.orange.100'
                    href='https://notes.ethereum.org/1yuzsI1iSY2HjXrImX5y9Q'
                ...
                <Accordion allowToggle>
                  ...
                  <FAQItem question='What makes for a good proposal?'>
                    <PageText>
                      ...
                      previous research work, who&apos;s involved and estimation regarding time and
                      budget. The more details you provide, the more likely we&apos;ll be able to
                      help.
                    </PageText>
                    ...
                    <Box>
                      ...
                      <List>
                        ...
                        <ListItem>
                          Detailed description of your project, milestones, the people involved and
                          how much time you think it will take to complete.
                        </ListItem>
                      </List>
                    </Box>
                  </FAQItem>
                  ...
                  <FAQItem question='What should the output be?'>
                    <PageText>
                      ...
                      research paper, an experimental report or some sort of comprehensive research
                      output. Whatever the output, the information should be open-sourced and
                      available for the broader community to use. The Intelectual Property can still
