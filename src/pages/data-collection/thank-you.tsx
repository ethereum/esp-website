...
const DataCollectionThankYou: NextPage = () => {
  return (
    <>
      <PageMetadata
        title='Thank you'
        description='Thank you for applying to the Data Collection Round.'
      />
      <Head>
        ...
        <Stack mb={10}>
          <section id='description'>
            ...
            <PageSubheading mb={16} textAlign='center'>
              for applying to the Data Collection Round
            </PageSubheading>
...
export default DataCollectionThankYou;
