  ...
  return new Promise(resolve => {
    ...
    conn.login(SF_PROD_USERNAME!, `${SF_PROD_PASSWORD}${SF_PROD_SECURITY_TOKEN}`, err => {
      ...
      const application = {
        ...
        npsp__CompanyCity__c: result.data.country,
        Timezone__c: result.data.timezone,
        ...
        Project_Repo_Link__c: result.data.projectRepoLink,
        ...
        Is_It_Public_Good__c: result.data.isItPublicGood,
        ...
        Event_Name__c: result.data.eventName,
        Event_Date__c: result.data.eventDate,
        Event_Link__c: result.data.eventLink,
        Event_Description__c: result.data.eventDescription,
        Event_Topics__c: result.data.eventTopics,
