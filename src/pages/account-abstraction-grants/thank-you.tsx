...
const AccountAbstractionThankYou: NextPage = () => {
  return (
    <>
      <PageMetadata
        title='Thank you'
        description='Thank you for applying to Account Abstraction Grants.'
      />
      <Head>
        ...
        <Stack mb={10}>
          <section id='description'>
            ...
            <PageSubheading mb={16} textAlign='center'>
              for applying to Account Abstraction Grants
            </PageSubheading>
...
export default AccountAbstractionThankYou;
