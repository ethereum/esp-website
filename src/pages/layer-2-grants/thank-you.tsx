...
const Layer2GrantsThankYou: NextPage = () => {
  return (
    <>
      <PageMetadata title='Thank you' description='Thank you for applying to the Layer 2 Grants' />
      <Head>
        ...
        <Stack mb={10}>
          <section id='description'>
            ...
            <PageSubheading mb={16} textAlign='center'>
              for applying to the Layer 2 Grants
            </PageSubheading>
...
export default Layer2GrantsThankYou;
