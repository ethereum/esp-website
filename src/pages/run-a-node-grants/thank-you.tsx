...
const RunANodeGrantsThankYou: NextPage = () => {
  return (
    <>
      <PageMetadata title='Thank you' description='Thank you for applying to Run A Node Grants.' />
      <Head>
        ...
        <Stack mb={10}>
          <section id='description'>
            ...
            <PageSubheading mb={16} textAlign='center'>
              for applying to Run A Node Grants
            </PageSubheading>
...
export default RunANodeGrantsThankYou;
