        ...
        <Stack mb={8}>
          <section id='mission-and-scope'>
            ...
            <PageText mb={6}>
              ...
              as open source tooling, building blocks and libraries, research, community building,
            ...
            <PageText mb={8}>
              ...
              development. We&apos;re open to supporting work from people and teams of all kinds.
            </PageText>
            ...
            <PageText mb={6}>
              ...
              rule and there are exceptions - for example, where an application serves as a research
              or educational tool, or a reference implementation of a new standard.
            </PageText>
          </section>
        </Stack>
        ...
        <Stack spacing={10}>
          <section id='how-we-support'>
            ...
            <PageText mb={6}>
              ...
              input from technical advisors. Grants are not donations or equity investments. We give
              grants to support recipients in building things that are vital to Ethereum&apos;s
              success, without the need to commercialize their work, so that these resources remain
              free and open to all. ESP grants are separated into two categories, small grants and
              project grants, each with a different process and criteria.
            </PageText>
            ...
            <PageText mb={6}>
              ...
              base; a creative and dedicated team; connections to leading developers, researchers
              and community members. Our goal is to deploy these resources as impactfully as we can.
              If funding isn&apos;t what&apos;s needed, builders can also book an office hours
              session for non-financial support such as project feedback or help navigating the
              Ethereum ecosystem.
            </PageText>
          </section>
          ...
          <section id='application-types'>
            ...
            <PageText mb={6}>
              Before submitting, please take time to understand the criteria and expectations for
              each type of application, as well as ESP&apos;s mission and scope in order to make
              sure you provide the appropriate information and context for us to make an informed
              decision on how to proceed with your application.
            </PageText>
          </section>
