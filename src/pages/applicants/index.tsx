...
import { OFFICE_HOURS_URL, PROJECT_GRANTS_URL, SMALL_GRANTS_URL } from '../../constants';
    ...
    <>
      ...
      <Stack mb={8}>
        <section id='mission-and-scope'>
          <PageSubheading mb={8}>ESP Grants and Support Overview</PageSubheading>
          ...
          <PageText mb={6}>
            ...
            open source tooling, building blocks and libraries, research, community building,
            educational resources, open standards, infrastructure and protocol improvements.
          </PageText>
          ...
          <Center mb={12} w={{ base: '100%', md: '670px' }}>
            <Flex direction={{ base: 'column', md: 'row' }}>
              <Stack mr={{ base: 0, md: 10 }} mb={{ base: 2, md: 0 }}>
                ...
                <Flex>
                  <Box mr={4}>
                    <Image src={researchersSVG} alt='Researchers vector' height={40} width={40} />
                  </Box>
          ...
          <PageText mb={6}>
            We don&apos;t often fund dapps or front-end platforms, although this is not a hard rule
            and there are exceptions - for example, where an application serves as a research or
            educational tool, or a reference implementation of a new standard.
          </PageText>
        </section>
      </Stack>
      ...
      <Stack spacing={10}>
        <section id='how-we-support'>
          ...
          <PageText mb={6}>
            Grants are direct funding, awarded following a formal application, evaluation, and input
            from technical advisors. Grants are not donations or equity investments. We give grants
            to support recipients in building things that are vital to Ethereum&apos;s success,
            without the need to commercialize their work, so that these resources remain free and
            open to all. ESP grants are separated into two categories, small grants and project
            grants, each with a different process and criteria.
          </PageText>

          <PageText mb={6}>
            ESP also provides non-financial support. The Ethereum Foundation has many valuable
            resources in addition to funding: visibility; access to a massive collective knowledge
            base; a creative and dedicated team; connections to leading developers, researchers and
            community members. Our goal is to deploy these resources as impactfully as we can. If
            funding isn&apos;t what&apos;s needed, builders can also book an office hours session
            for non-financial support such as project feedback or help navigating the Ethereum
            ecosystem.
          </PageText>
        </section>
        ...
        <section id='application-types'>
          ...
          <PageText mb={6}>
            There are several ways to request support from ESP. Choose an application type to see
            which one might be a fit for you and learn more about the process.
          </PageText>

          <PageText mb={6}>
            Before submitting, please take time to understand the criteria and expectations for each
            type of application, as well as ESP&apos;s mission and scope in order to make sure you
            provide the appropriate information and context for us to make an informed decision on
        ...
        <Center>
          <Stack spacing={4}>
            ...
            <ApplicationTypeCard title='Small Grants' link={SMALL_GRANTS_URL}>
              Small grants, capped at $30,000, have a streamlined application and evaluation process
              to deliver a decision around two weeks after submission.
            </ApplicationTypeCard>

            <ApplicationTypeCard title='Project Grants' link={PROJECT_GRANTS_URL}>
              Project grants have no specific funding cap, and undergo a more intensive process of
              review and potentially rescoping. Timelines vary widely depending on scope and
              complexity.
            </ApplicationTypeCard>
          </Stack>
        </Center>
