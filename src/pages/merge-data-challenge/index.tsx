            ...
            <Box w={{ lg: '70%' }} px={{ md: 20 }} pr={{ lg: 12 }}>
              ...
              <Stack mb={8} mt={{ base: 10, md: 0 }}>
                <section id='description' ref={ref}>
                  <PageSubheading mb={8}>The Merge data challenge</PageSubheading>

                  <PageText mb={6} fontStyle='italic'>
                    Up until October 31st, 2022, the Ethereum Foundation is sponsoring a Merge data
                    analysis and data visualization blog post challenge. Here are all the details
                    you need.
                  </PageText>
                  ...
                  <PageText mb={6}>
                    ...
                    is coming, providing a more secure and sustainable home for Ethereum—as well as
                    more data, lots and lots of data. And{' '}
                    <strong>the Ethereum community needs your help to make sense of it all.</strong>
                  </PageText>
                  ...
                  <List>
                    ...
                    <ListItem>
                      <PageText fontStyle='italic'>
                        How do the consensus layer and execution layer interact? Are there
                        differences across client pairs in communication patterns, efficiency, etc?
                        Are there good places to optimize?
                      </PageText>
                    </ListItem>
                    <ListItem>
                      <PageText fontStyle='italic'>
                        What, if anything, changed on the network at the point of The Merge—block
                        propagation times, p2p connections, transaction mempool performance, etc?
                      </PageText>
                    </ListItem>
                    <ListItem>
                      <PageText fontStyle='italic'>
                        Did The Merge affect core Beacon Chain activity—attestation performance,
                        blocks missed, sync committees?
                      </PageText>
                    </ListItem>
                    <ListItem>
                      <PageText fontStyle='italic'>
                    ...
                    <ListItem>
                      <PageText fontStyle='italic'>
                        What new tools can you build to collect and analyze data in the post-Merge
                        network?
                      </PageText>
                    </ListItem>
                  </List>
              ...
              <Stack spacing={10}>
                <section id='the-challenge' ref={ref2}>
                  ...
                  <PageText mb={6}>
                    <strong>
                      Document your best Merge data insights in the most readable blog post
                      possible—for prizes!
                    </strong>
                  </PageText>
                  ...
                  <PageText mb={6}>
                    ...
                    and discover from the Merge mainnet activity. Your findings will give the
                    Ethereum community – from beginners to researchers and client developers –
                    important insight into the Merge.
                  </PageText>

                  <PageText mb={6}>
                    Get started now if you want to gather date from both before and after the big
                    event!
                  </PageText>
                </section>
              </Stack>
              ...
              <Stack>
                <section id='how-to-submit' ref={ref3}>
                  ...
                  <PageText mb={6}>Anyone is free to submit, here’s how:</PageText>
                  ...
                  <PageText mb={6} fontStyle='italic'>
                    ...
                    different visualization or piece of analysis
                  </PageText>
                  ...
                  <PageText mb={6}>
                    A group of Ethereum community members will evaluate your submissions and awards
                    will go to the top blog posts 🏆
                  </PageText>
                </section>
              </Stack>
              ...
              <Stack spacing={10}>
                <section id='judging-criteria' ref={ref7}>
                  ...
                  <PageText mb={6} fontStyle='italic'>
                    Surprise us with your creativity! But here are some judging criteria
                    considerations:
                  </PageText>
                  ...
                  <Box mb={6}>
                    <List>
                      ...
                      <ListItem>
                        ...
                        -{' '}
                        <PageText as='span' fontStyle='italic'>
                          Discord
                        </PageText>
                      </ListItem>
                      <ListItem>
